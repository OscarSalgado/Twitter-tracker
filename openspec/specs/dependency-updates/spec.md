...
## Purpose
Keeps the project's pinned dependencies from silently going stale or vulnerable by having Dependabot propose updates on a regular schedule, instead of relying on someone noticing during a manual review.
